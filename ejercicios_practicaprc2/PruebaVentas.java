...
public class PruebaVentas {
	...
	public static void main(String[] args) {
		...
		VentasEmpleado maricela = new VentasEmpleado("Maricela", "Quintana", ventas2);
                ...
                System.out.println("Las ventas de Arturo Rosas son: \n");
		System.out.println(arturo);
			
		System.out.println("\nPromedio de ventas de Arturo : " + arturo.promedio());

		System.out.println("El mes de mejores ventas de Arturo es : " + arturo.mayorVenta());
		
		System.out.println("El mes de peores ventas de Arturo es : " + arturo.menorVenta());

                System.out.println("\nLas ventas de Marco Arellano son: \n");
		...
		System.out.println("\nVentas actualizadas de marco\n");
                ...
                System.out.println("Las ventas de Marco Arellano son: \n");
		System.out.println(marco);

		System.out.println("\nEl mes de mejores ventas de Marco es : " + marco.mayorVenta());
		
                System.out.println("\nLas ventas de Maricela Quintana son: \n");
		System.out.println(maricela);
